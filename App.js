  ...
  function Mydrawtabs() {
    return (
      <drawer.Navigator  screenOptions={{
        ...
        <drawer.Screen name="Home" component={MytopTabs}  options={{ headerTintColor:"#19e68c" ,  headerStyle:{backgroundColor:"#141714"} , drawerActiveBackgroundColor:"#4f5c4f" , drawerActiveTintColor:"#19e68c"  , drawerInactiveTintColor:"white" , drawerIcon:({color, size})=>(<Entypo name="home" size={size} color={color} />)}} />
        <drawer.Screen name="Add Account" component={Addaccount}  options={{ headerTintColor:"#19e68c" ,  headerStyle:{backgroundColor:"#141714"} ,  drawerActiveBackgroundColor:"#4f5c4f" , drawerActiveTintColor:"#19e68c"  , drawerInactiveTintColor:"white" ,  drawerIcon:({color, size})=>(<AntDesign name="pluscircleo" size={size} color={color} />)}} />
        <drawer.Screen name="User" component={Profilepage}  options={{ headerTintColor:"#19e68c" ,  headerStyle:{backgroundColor:"#141714"} ,  drawerActiveBackgroundColor:"#4f5c4f" , drawerActiveTintColor:"#19e68c"  , drawerInactiveTintColor:"white" ,  drawerIcon:({color, size})=>(<AntDesign name="user" size={size} color={color} />)}} />
        <drawer.Screen name="What's new" component={Whatsisnew}  options={{ headerTintColor:"#19e68c" ,  headerStyle:{backgroundColor:"#141714"} ,  headerTintColor:"#19e68c" ,  headerStyle:{backgroundColor:"#141714"} ,  drawerActiveBackgroundColor:"#4f5c4f" , drawerActiveTintColor:"#19e68c"  , drawerInactiveTintColor:"white" ,  drawerIcon:({color, size})=>(<FontAwesome6 name="bolt-lightning" size={size} color={color} />)}} />
        <drawer.Screen name="Recents" component={Recents}  options={{ headerTintColor:"#19e68c" ,  headerStyle:{backgroundColor:"#141714"} ,  drawerActiveBackgroundColor:"#4f5c4f" , drawerActiveTintColor:"#19e68c"  , drawerInactiveTintColor:"white" ,  drawerIcon:({color, size})=>(<Entypo name="back-in-time" size={size} color={color} />)}} />
        <drawer.Screen name="Settings and privacy" component={Settingsandprivacy}  options={{ headerTintColor:"#19e68c" ,  headerStyle:{backgroundColor:"#141714"} ,  drawerActiveBackgroundColor:"#4f5c4f" , drawerActiveTintColor:"#19e68c"  , drawerInactiveTintColor:"white" ,  drawerIcon:({color, size})=>(<AntDesign name="setting" size={size} color={color} />)}} />
      </drawer.Navigator>
    ) 
  }
